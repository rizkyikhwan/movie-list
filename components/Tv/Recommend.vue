<template>
  <div class="recommend-mov py-3">
    <div class="d-flex justify-content-between">
      <h5 class="font-weight-bold title">Recommendation Series</h5>
      <div class="wrap-navigation d-none d-md-flex">
        <button id="prev-recommend-tv" class="btn-nav d-flex align-items-center bg-transparent">
          <fa icon="chevron-left" class="icon-nav" />
        </button>
        <button id="next-recommend-tv" class="btn-nav d-flex align-items-center bg-transparent">
  ...
  data() {
    return {
      swiperOption: {
        ...
        navigation: {
          nextEl: '#next-recommend-tv',
          prevEl: '#prev-recommend-tv'
        }
      },
    }
  }
